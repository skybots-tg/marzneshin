...
class UsersStats(_message.Message):
    ...
    class UserStats(_message.Message):
        __slots__ = ("uid", "usage", "remote_ip", "uplink", "downlink", "client_name", "user_agent")
        ...
        client_name: str
        user_agent: str
        def __init__(self, uid: _Optional[int] = ..., usage: _Optional[int] = ..., remote_ip: _Optional[str] = ..., uplink: _Optional[int] = ..., downlink: _Optional[int] = ..., client_name: _Optional[str] = ..., user_agent: _Optional[str] = ...) -> None: ...
